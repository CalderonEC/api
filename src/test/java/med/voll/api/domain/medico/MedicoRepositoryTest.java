...
class MedicoRepositoryTest {
    ...
    void seleccionarMedicoConEspecialidadEnFechaEscenario1() {
        ...
        var medico = registrarMedico("Jose", "jose@mail.com","235666",Especialidad.CARDIOLOGIA);
        var paciente = registrarPaciente("Antonio","anto@mail.com","13131");
    ...
    private DatosRegistroPaciente datosPaciente(String nombre, String email, String documento) {
        return new DatosRegistroPaciente(nombre,
                email,
                "61999999",
                documento,
                datosDireccion()
